# Time Series with LSTM example
# business-science.io/timeseries-analysis/2018/04/18/
# keras-lstm-sunspots-time-series-prediction.html
...
######
# We can see that the cycle (10-year frequency) 
# and amplitude (count of sunspots) 
# seems to change at least between years 1780 and 1800. 
...
# This graph is supposed to show that the ACF is less than 10 years due to 
# ACF crosses zero multiple times.
...
# This is good news. We have autocorrelation in excess of 0.5 beyond lag 120 
# (the 10-year mark). We can theoretically use one of the high autocorrelation 
# lags to develop an LSTM model.
...
# how to filter to find best lag
...
# lstm plan; also look at LSTM Plan.txt
